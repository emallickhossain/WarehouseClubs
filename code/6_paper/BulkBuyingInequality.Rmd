...
\begin{abstract}
\singlespace
\noindent Quantity discounts are an effective way for households to save money. My paper explores how large quantity discounts are, how bulk buying differs by income and what factors affect the bulk buying decision. Using Nielsen's granular store-level and household-level data, I show that quantity discounts are large for a wide range of products and low-income households are less likely to buy in bulk. I estimate that low-income households could reduce their grocery expenditures by 5\%, saving an aggregate of \$5.4 billion annually, if they bought in bulk like high-income households. By augmenting the Nielsen data with novel data I collected on state-level unit-price regulations and new data on warehouse club entry, I find evidence that a combination of cognitive costs, store preferences, and storage costs discourage low-income households from realizing these savings. I then estimate a discrete choice model of household purchasing behavior to quantify how bulk buying changes when cognitive costs and storage costs are reduced. Counterfactual simulations show that mandating the display of unit prices, which has only been adopted by nine states, would reduce the bulk buying gap between the highest and lowest income households by 27\%.
\end{abstract}

\newpage

# Introduction
Grocery purchases account for a sizable share of a household's discretionary spending [@bls2017]. To save money, households often wait for sales, redeem coupons, or purchase generic brands [@nevo2009]. Low-income groups also increase their home production and time spent shopping to further reduce their spending [@aguiar2005]. Quantity discounts are another way for households to save money. Even though households buy more at one time, they pay lower unit prices, and reduce their overall spending. 

My paper examines how common quantity discounts are, how bulk buying varies by income groups, and which factors influence the decision to buy in bulk. Most explanations for why households pay different prices for the same product relate to differences in search behavior. Prices vary based on where households shop, whether they buy on sale, or whether they use coupons [@talukdar2008; @nevo2009; @kaplan2015]. However, even in the absence of sales and coupons, prices for the same product can differ within a particular store because of quantity discounts.

This paper presents new findings that, despite the substantial savings available from quantity discounts, low-income households are less likely to buy in bulk than high-income households.^[Throughout this paper, "high-income" refers to households making over \$100,000 and "low-income" refers to households making under \$25,000.] @kunreuther1973 provides the first evidence of this "bulk buying gap" for eight specific products and @orhun2018 expands this finding to the whole toilet paper category. Since households purchase a wide range of products when shopping, I show that the "bulk buying gap" exists across a wide range of product categories.

I find that cognitive costs, store preferences, and storage costs contribute to this bulk buying gap. Cognitive costs can prevent households from making economical decisions and households change their purchase decisions when relevant price information is displayed prominently [@mullainathan2006; @chetty2009; @goldin2013; @mullainathan2013]. Lab experiments and small field experiments find that consumers also change their buying behavior when unit prices are posted [@miyazaki2000; @bogomolova2016]. I build on both of these facts and show that households are more likely to buy in bulk when retailers are mandated to display unit prices, reducing cognitive costs. Households may also make different purchase decisions based on the types of stores they shop at or the neighborhoods they shop in [@chung1999; @talukdar2008; @handbury2019]. I show that where a household shops, but not where a household lives, greatly affects differences in bulk buying.

This paper also provides a new approach to estimate storage costs cross-sectionally using differences in product "concentration." Firms can use nonlinear prices to discriminate between households with varying storage costs and these storage costs can be estimated using household purchase histories [@hendel2006a; @hendel2014]. The intuition of their approach is the following: given households with the same demand for a product, the household with high storage costs will purchase more frequently than the household with low storage costs. The intuition of my approach is that households that buy more concentrated, smaller packages have higher storage costs than those that buy less concentrated, larger packages. Furthermore, I provide evidence that low-income households have high storage costs while high-income households have low storage costs. On balance, this means that firms extract higher rents from low-income households because they have less ability to store for future consumption.

I use a combination of household- and store-level datasets to study income heterogeneity in bulk buying, including Nielsen's Consumer Panel data, a nationally representative panel survey of household grocery purchases, and Nielsen's Retail Scanner data, a national panel of weekly UPC-level sales data from over 30,000 stores. I construct a new dataset of state-level per-unit pricing regulations, including a measure of regulatory stringency. I also use data on entry dates and locations of over 1,400 warehouse clubs in the United States. As a result, I have a comprehensive view of household's possible product choices, available price information, retail environment, and resulting expenditures.

I start by documenting income differences in bulk buying and estimating how much low-income households could save from buying in bulk like high-income households. To do this, I estimate the average bulk discount for each product category based on Nielsen's weekly store-level price and product data. Then, I estimate how much each household buys in bulk using Nielsen's household-level purchase data. Given each product category-specific bulk discount and household-level bulk buying, I predict how much low-income households could have saved if they increased their bulk buying to match that of high-income households. I find that low-income households could reduce their grocery expenditures by 5\% if they bought in bulk like high-income households, saving an aggregate of \$5.4 billion annually. 

I then use two differences-in-differences models to determine how much cognitive costs and store preferences affect bulk buying. The first one leverages a novel dataset that I compiled of state regulations regarding the display of per-unit prices. I exploit the fact that thousands of households move between regulatory regimes when they move from one state to another. Before a household moves, they exhibit no trends in their bulk buying. After a move, there is a significant change in their bulk buying. I find that a household's bulk buying is 2-3\% higher when they are in a state where unit prices are displayed.

The second differences-in-differences model examines how much store preferences, particularly warehouse clubs, affect bulk buying. The bulk buying gap narrows substantially after controlling for the types of stores households shop at and high-income households spend a larger portion of their budget at warehouse clubs. To estimate the effect of warehouse clubs on bulk buying, I examine how bulk buying changes within households before and after a warehouse club enters nearby. Warehouse club entry increases bulk buying by 5--10\%, but only for middle- and high-income households. 

I also assess the importance of storage costs using differences in bulk buying relative to the size of a household's home and relative to the physical size of the product being purchased. I examine how a household's bulk buying changes when they move to a different type of housing after controlling for other within-household changes. Bulk buying is 2.6--4.0\% higher when households live in single-family homes relative to when they live in apartments, controlling for demographic changes. I also find that the bulk buying gap is smaller for products with smaller physical footprints.

Finally, I construct a discrete-choice model of toilet paper purchases to quantify the direct effect of reducing storage costs or posting unit prices on bulk buying. Households choose a product based on price, quantity, quality, and package size, which serves as a proxy for storage costs. I allow state-level unit pricing mandates to affect a household’s unit price sensitivity. From this demand model, I simulate household responses to two counterfactuals: (1) universally posting unit prices and (2) reducing storage costs.

The model predicts that posting unit prices would reduce the gap in package size purchased between high- and low-income households by 27\% and reducing storage costs narrow the gap by an additional 27\%. These two channels account for over 90\% of the differences in gap between middle- and high-income households. If policymakers want to encourage households to better utilize quantity discounts, displaying unit prices would reduce cognitive costs, increase bulk buying, and help consumers save money.
