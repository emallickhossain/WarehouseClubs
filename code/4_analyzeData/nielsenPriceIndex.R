...
# Get products
prod <- fread(paste0("/home/mallick/Desktop/Nielsen/Data/Consumer_Panel_Data",
                     "_2004-2016/nielsen_extracts/HMS/Master_Files/Latest/products.tsv"),
              select = c("upc", "upc_ver_uc", "department_code"), quote = "",
              key = c("upc", "upc_ver_uc"))
if (dropMag) assign("prod", prod[department_code != 99])
