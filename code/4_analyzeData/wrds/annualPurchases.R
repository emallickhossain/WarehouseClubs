...
ggsave(filename = "figures/annualPurchasesTP.pdf", height = 4, width = 6)
# ggsave(filename = "figures/annualPurchasesTPColor.pdf", height = 4, width = 6)
...
ggplot(data = graphData[reg == "Income, Annual Purch, and Demographics"],
  ...
  theme(axis.title = element_text(),
        ...
        legend.position = "bottom") +
  scale_color_grey()
ggsave(filename = "figures/avgPkgSizeByIncome.pdf", height = 4, width = 6)
