...
export(chart, paste0("./code/5_figures/nielsenChannelPropensitiesTripLevelsConditional.png"))
...
chart <- subplot(charts, nrows = 2, shareX = TRUE, shareY = TRUE, margin = 0.03) %>%
  ...
  layout(title = "Average Monthly Shopping Trips by Channel and Income (2004-2016)",
         ...
         annotations = list(text = "Source: Nielsen.",
                            ...
                            showarrow = FALSE, align = "left", valign = "bottom",
                            xref = "paper", x = -0.03, yref = "paper", y = -0.22))
export(chart, paste0("./code/5_figures/nielsenChannelPropensitiesTripSharesConditional.png"))
...
chart <- subplot(charts, nrows = 2, shareX = TRUE, shareY = TRUE, margin = 0.03) %>%
  ...
  layout(title = "Average Monthly Expenditures by Channel and Income (2004-2016)",
         ...
         annotations = list(text = "Source: Nielsen.",
                            ...
                            showarrow = FALSE, align = "left", valign = "bottom",
                            xref = "paper", x = -0.03, yref = "paper", y = -0.22))
export(chart, paste0("./code/5_figures/nielsenChannelPropensitiesSpendLevelsConditional.png"))
...
chart <- subplot(charts, nrows = 2, shareX = TRUE, shareY = TRUE, margin = 0.03) %>%
  ...
  layout(title = "Average Monthly Expenditures by Channel and Income (2004-2016)",
         ...
         annotations = list(text = "Source: Nielsen.",
                            ...
                            showarrow = FALSE, align = "left", valign = "bottom",
                            xref = "paper", x = -0.03, yref = "paper", y = -0.22))
export(chart, paste0("./code/5_figures/nielsenChannelPropensitiesSpendSharesConditional.png"))
